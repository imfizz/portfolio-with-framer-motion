...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_a2gezvf', 'template_jyhekd7', formRef.current, 'j10vmxdO9C8KmX-A4')
        .then((result) => {
            setSuccess(true);
        }, (error) => {
            setError(true);
  ...
  return ( 
    ...
    >
        ...
        <div className="formContainer">
            ...
            >
                <svg height="500" fill="transparent" stroke-width="3" width="500px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.107 512.107" xml:space="preserve">
                    <g>
                        <g>
                            <motion.path 
